...
axes[1, 1].set_xlabel('Items Purchased')
axes[1, 1].set_ylabel('Average Rating')

#visual 5: Total Spend by Satisfaction Level (Boxplot)  
sns.boxplot(x='Satisfaction Level', y='Total Spend', data=df, palette='Set2')
plt.title('5. Total Spend by Satisfaction Level', fontsize=14)
