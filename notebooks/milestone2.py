...
# We use .iloc[0] to ensure we get a single string value from the Mode series
...
# Add dtype=int to get_dummies for 1s and 0s
...
# %% [7] FEATURE ENGINEERING: NEW METRICS
if 'Total Spend' in df.columns and 'Items Purchased' in df.columns:
    ...
    # Create a binary flag for High Spenders
...
# Scaler needs a list of columns that exist
